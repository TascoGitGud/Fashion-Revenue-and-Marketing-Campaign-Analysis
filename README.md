...
>
> - 🔖 **Bookmarks & Button** — A hidden filter panel is toggled by clicking the funnel icon (🔽) on the top right of each page. The panel slides in with: Date Range slider (May 1–31, 2024), and slicers for Product Name, Category, City, and Region — all applied simultaneously across the report page.
>
