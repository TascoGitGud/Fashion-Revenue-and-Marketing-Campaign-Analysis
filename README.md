...
- On days with **244 campaigns** running at the same time, ROAS fell to around **3-4** (May 02). When campaigns were cut down to **128**, ROAS recovered to **~25**. Too many campaigns running at once is spreading the budget too thin and pulling overall performance down.
