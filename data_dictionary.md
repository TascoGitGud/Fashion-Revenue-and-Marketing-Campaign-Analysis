...
| Tiền đã chạy \nTheo Sản phẩm | Number | Ad spend allocated to this product (VND) |
| Ngân sách\nTheo sản phẩm | Number | Budget allocated to this product (VND) |
| Inbox\nTheo AM | Number | Inbox conversations allocated to this product |
| Comments\nTheo AM | Number | Comments allocated to this product |
| Inbox + Comments\nTheo AM | Number | Total inbox + comments allocated to this product |
| CP/KQ\nTheo AM | Number | Cost per result allocated to this product (VND) |
| CPM\nTheo AM | Number | Cost per 1,000 impressions allocated to this product (VND) |
| CPC\nTheo AM | Number | Cost per click allocated to this product (VND) |
| CTR\nTheo AM | Number | Click-through rate allocated to this product |
| Khách mới\nTheo AM | Number | New customers allocated to this product |
| Khách cũ\nTHeo AM | Number | Returning customers allocated to this product |
| Lượt hiển thị\nTheo AM | Number | Impressions allocated to this product |
...
- Column headers in `mkt_camp_by_sku_cost` contain line breaks (`\n`) - watch for trailing/leading spaces in column names (e.g., `" Inbox\nTheo AM"`).
